    ...
    <div class="container-fluid">
    	...
    	<div class="row">
	    	...
	    	<div class="col-md-8">
	    		...
	    		<a class="btn btn-default addshanghu" href="<?php echo U('Shanghu/addShanghuList',array('id'=>$shanghuiInfo['id']));?>" role="button">增加商户</a>
    			      ...
    			      <table class="table table-striped">
					        ...
					        <tbody>
							   <?php if(is_array($shanghuInfo)): foreach($shanghuInfo as $key=>$vo): ?><tr>
								  <td><a href=""><?php echo ($vo["shname"]); ?></a></td>
					              <td><?php echo ($vo["ismoney"]); ?></td>
								  <td><?php echo ($vo["isvip"]); ?></td>
					              <td><a title="<?php echo ($vo["id"]); ?>" href="<?php echo U('Shanghu/updateShanghuList',array('id'=>$vo['id']));?>">修改</a></td>
